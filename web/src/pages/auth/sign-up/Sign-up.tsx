    ...
    <form onSubmit={handleSubmit(onCreateAccount)}>
      <FormGroup
        ...
        inputProps={{
          ...
          register: { ...register(FORM_SIGNUP_IDS.firstName, { required: true, maxLength: 30 }) },
          formErrorMessage:
      ...
      <FormGroup
        ...
        inputProps={{
          ...
          register: { ...register(FORM_SIGNUP_IDS.lastName, { required: true, maxLength: 30 }) },
          formErrorMessage:
      ...
      <FormGroup
        ...
        inputProps={{
          ...
          formErrorMessage:
            ...
            getErrorMessageForRegexPasswordNotMatch(errors.confirmationPassword)
        }}
      />
